...
@MainActor
public protocol TranscriptionSettingsProtocol: AnyObject {
...
public extension TranscriptionSettingsProtocol {
    /// Apply vocabulary replacements to text
    func applyVocabulary(to text: String) -> String {
        var result = text
...
@MainActor
public protocol MinimalTranscriptionSettingsProtocol: AnyObject {
    /// Currently selected transcription provider
    var selectedTranscriptionProvider: AIProvider { get }

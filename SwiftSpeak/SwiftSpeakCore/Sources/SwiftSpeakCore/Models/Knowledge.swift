...
public enum KnowledgeDocumentType: String, Codable {
...
public enum UpdateInterval: String, Codable, CaseIterable {
    case never = "never"
    case daily = "daily"
    case weekly = "weekly"
...
public struct KnowledgeDocument: Codable, Identifiable, Equatable {
    public let id: UUID
    public var name: String
    public var type: KnowledgeDocumentType
    public var sourceURL: URL?           // For remote documents
    public var localPath: String?        // For uploaded files
    public var contentHash: String       // For update detection
    public var chunkCount: Int
    public var fileSizeBytes: Int
    public var isIndexed: Bool
    public var lastUpdated: Date
    public var autoUpdateInterval: UpdateInterval?
    ...
    public static var samples: [KnowledgeDocument] {
        [
            KnowledgeDocument(

...
/// Configuration for what context to include when running a Power Mode
public struct PowerModeInputConfig: Codable, Equatable, Hashable, Sendable {
    /// Include global AI memory
    public var includeGlobalMemory: Bool
    /// Include power mode specific memory
    public var includePowerModeMemory: Bool
    /// Include attached RAG documents
    public var includeRAGDocuments: Bool
    /// Include Obsidian vault search results
    public var includeObsidianVaults: Bool
    /// macOS: Include currently selected text from active app
    public var includeSelectedText: Bool
    /// macOS: Include text from active application window
    public var includeActiveAppText: Bool
    /// macOS: Include clipboard contents
    public var includeClipboard: Bool

    public init(
        includeGlobalMemory: Bool = true,
        includePowerModeMemory: Bool = true,
        includeRAGDocuments: Bool = true,
        includeObsidianVaults: Bool = true,
    ...
    public static let `default` = PowerModeInputConfig()
}

// MARK: - Power Mode Output Action

/// Primary output delivery method for Power Mode results
public enum PowerModeOutputAction: String, Codable, CaseIterable, Sendable {
    case clipboard = "clipboard"
    case clipboardAndTextField = "clipboardAndTextField"
    case textFieldOnly = "textFieldOnly"

    public var displayName: String {
        switch self {
        case .clipboard: return "Copy to Clipboard"
        case .clipboardAndTextField: return "Copy & Insert"
        case .textFieldOnly: return "Insert at Cursor"
        }
    }

    public var description: String {
        switch self {
        case .clipboard: return "Copy the result to clipboard only"
        case .clipboardAndTextField: return "Copy to clipboard and insert at cursor"
        case .textFieldOnly: return "Insert directly at cursor position"
        }
    }
    ...
    public var icon: String {
        ...
        case .clipboardAndTextField: return "doc.on.doc.fill"
...
/// Configuration for how to deliver Power Mode results
public struct PowerModeOutputConfig: Codable, Equatable, Hashable, Sendable {
    /// Primary output delivery method
    public var primaryAction: PowerModeOutputAction
    /// Press Enter/Return after inserting text
    public var autoSendAfterInsert: Bool
    /// Enable webhook delivery
    public var webhookEnabled: Bool
    /// IDs of webhooks to trigger
    public var webhookIds: [UUID]
    /// Obsidian save action (optional)
    public var obsidianAction: ObsidianActionConfig?
    ...
    public static let `default` = PowerModeOutputConfig()
}
...
public struct PowerMode: Codable, Identifiable, Equatable, Hashable {
    ...
    public var obsidianVaultIds: [UUID]           // Which vaults to query
    ...
    public init(from decoder: Decoder) throws {
        ...
        if let decoded = try container.decodeIfPresent(PowerModeInputConfig.self, forKey: .inputConfig) {
            ...
            inputConfig = PowerModeInputConfig(
                includeGlobalMemory: true,
                includePowerModeMemory: memoryEnabled,
                includeRAGDocuments: !knowledgeDocumentIds.isEmpty,
                includeObsidianVaults: !obsidianVaultIds.isEmpty,
                includeSelectedText: true,
                includeActiveAppText: includeWindowContext,
                includeClipboard: false
            )
        }

        if let decoded = try container.decodeIfPresent(PowerModeOutputConfig.self, forKey: .outputConfig) {
            outputConfig = decoded
        } else {
            // Migrate from legacy fields
            outputConfig = PowerModeOutputConfig(
                primaryAction: .clipboardAndTextField,
                autoSendAfterInsert: enterSendsMessage,
                webhookEnabled: !enabledWebhookIds.isEmpty,
                webhookIds: enabledWebhookIds,
...
public struct ObsidianActionConfig: Codable, Equatable, Hashable, Sendable {
    public var action: ObsidianAction
    public var targetVaultId: UUID
...
public enum ObsidianAction: String, Codable, CaseIterable, Sendable {

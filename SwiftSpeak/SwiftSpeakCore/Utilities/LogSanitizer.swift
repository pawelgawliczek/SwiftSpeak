...
public enum LogSanitizer {
    ...
    public static func sanitizeContent(_ text: String?) -> String {
    ...
    public static func sanitizeAudio(duration: TimeInterval) -> String {
    ...
    public static func sanitizeFile(url: URL?) -> String {
    ...
    public static func sanitizeAPIKey(_ key: String?) -> String {
    ...
    public static func sanitizeError(_ error: Error) -> String {
    ...
    public static func sanitizeWebhook(name: String?) -> String {
    ...
    /// - Returns: Sanitized string
    public static func sanitizeMemory(_ memory: String?) -> String {
    ...
    public static func sanitizeContext(name: String?) -> String {
        guard let name = name, !name.isEmpty else {
            return "[context: none]"
        }
        return name
    ...
    /// - Returns: Sanitized string
    public static func sanitizeTemplate(name: String?) -> String {
        guard let name = name, !name.isEmpty else {

...
public struct ProviderFactory {
    ...
    public init(settings: SharedSettings? = nil) {
    ...
    public func createTranscriptionProvider(for provider: AIProvider) -> TranscriptionProvider? {
    ...
    public func createTranslationProvider(for provider: AIProvider) -> TranslationProvider? {
        guard let config = settings.getAIProviderConfig(for: provider),
    ...
    public func createSelectedTranslationProvider() -> TranslationProvider? {
    ...
    public func createFormattingProvider(for provider: AIProvider) -> FormattingProvider? {
        guard let config = settings.getAIProviderConfig(for: provider),
    ...
    public func createSelectedFormattingProvider() -> FormattingProvider? {
    ...
    public func isProviderConfigured(_ provider: AIProvider, for category: ProviderUsageCategory) -> Bool {
    ...
    public func configuredProviders(for category: ProviderUsageCategory) -> [AIProvider] {
    ...
    public func createStreamingFormattingProvider(for provider: AIProvider) -> StreamingFormattingProvider? {
        switch provider {
        case .openAI:
    ...
    public func createSelectedStreamingFormattingProvider() -> StreamingFormattingProvider? {
...
private final class AnthropicTranslationAdapter: TranslationProvider {
    ...
    public var isConfigured: Bool { formattingService.isConfigured }
    public var model: String { formattingService.model }
    public var supportedLanguages: [Language] { Language.allCases }
    public var supportsFormality: Bool { true } // LLM can understand formality through context

    private let formattingService: AnthropicService

    public init(formattingService: AnthropicService) {

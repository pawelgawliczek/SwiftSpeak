...
public struct PromptSanitizer {
    ...
    public static func sanitize(_ text: String, maxLength: Int? = nil) -> String {
        var result = text
    ...
    public static func unescapeXML(_ text: String) -> String {
        text.replacingOccurrences(of: "&amp;", with: "&")
            .replacingOccurrences(of: "&lt;", with: "<")
            .replacingOccurrences(of: "&gt;", with: ">")
            .replacingOccurrences(of: "&quot;", with: "\"")
    ...
    public static func detectInjection(_ text: String) -> Bool {
    ...
    public static func analyzeForInjection(_ text: String) -> InjectionAnalysis {
    ...
    public static func normalizeUnicode(_ text: String) -> String {
        var result = text
...
public struct InjectionAnalysis {
    public let isClean: Bool
    public let detectedPatterns: [String]
    public let suspiciousElements: [String]
    public let riskLevel: InjectionRiskLevel
...
public enum InjectionRiskLevel: String, Codable {
    case none = "none"
    case low = "low"
    case medium = "medium"
    case high = "high"
...
public extension String {
    ...
    public var sanitizedForPrompt: String {
        PromptSanitizer.sanitize(self)
    }

    /// Check if this string contains injection patterns
    public var containsInjectionPatterns: Bool {

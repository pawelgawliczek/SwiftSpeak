...
public actor MemoryUpdateCoordinator {
    ...
    public init(memoryManagerProvider: @escaping @MainActor @Sendable () -> MemoryManager) {
    ...
    public func processQueue() async -> QueueProcessingResult {
...
public extension MemoryUpdateCoordinator {
    /// Create a coordinator with the shared memory manager
    @MainActor
    public static func shared() -> MemoryUpdateCoordinator {
...
public protocol MemoryUpdateCoordinatorProtocol: Sendable {
    public func updateMemory(
        text: String,
        context: ConversationContext?,
        powerMode: PowerMode?
    ...
    public func processQueue() async -> MemoryUpdateCoordinator.QueueProcessingResult
    public func clearQueue() async
    public var pendingCount: Int { get async }
}

// MARK: - Actor Conformance

public extension MemoryUpdateCoordinator: MemoryUpdateCoordinatorProtocol {

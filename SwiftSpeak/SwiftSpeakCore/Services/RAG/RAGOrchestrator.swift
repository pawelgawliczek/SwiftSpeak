...
public enum RAGOrchestratorError: Error, LocalizedError {
    case notConfigured
...
public struct IngestionProgress {
    public let stage: IngestionStage
...
public struct RAGQueryResult {
    public let contextText: String
    public let chunks: [SimilarityResult]
...
final class RAGOrchestrator: ObservableObject {
    ...
    public func configure(openAIApiKey: String) throws {
    ...
    public func getDocumentsNeedingRefresh(documents: [KnowledgeDocument]) -> [KnowledgeDocument] {
        let now = Date()
    ...
    public var sessionEmbeddingCost: Double {

...
public enum RAGSecurityError: Error, LocalizedError {
...
public struct RAGLimits {
    /// Maximum document size: 10 MB
    public static let maxDocumentSize: Int64 = 10 * 1024 * 1024

    /// Maximum documents per Power Mode
    public static let maxDocumentsPerPowerMode = 20

    /// Maximum total documents across all Power Modes
    public static let maxTotalDocuments = 100

    /// Maximum chunk size in tokens (approximate)
    public static let maxChunkTokens = 500

    /// Overlap between chunks in tokens
    public static let chunkOverlapTokens = 50

    /// Maximum chunks to include in context
    public static let maxContextChunks = 5

    /// Allowed file extensions
    public static let allowedExtensions: Set<String> = ["pdf", "txt", "md", "markdown"]

    /// Maximum URL content size for remote documents
    public static let maxRemoteContentSize: Int64 = 5 * 1024 * 1024 // 5 MB for remote
}

// MARK: - URL Whitelist

public struct URLWhitelist {
    ...
    public static func getDomain(from url: URL) -> String {
...
public struct ContentSanitizer {
    ...
    public static func checkForSuspiciousContent(_ content: String) -> String? {
...
final class RAGSecurityManager {
    ...
    public static let shared = RAGSecurityManager()
    ...
    public func validateURLString(_ urlString: String) throws -> URL {
    ...
    public func validateContent(_ content: String, fileSize: Int64? = nil) throws -> String {
    ...
    public func validateDocumentCount(

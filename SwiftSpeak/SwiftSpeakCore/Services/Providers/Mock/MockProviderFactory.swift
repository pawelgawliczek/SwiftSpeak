...
public extension MockProviderFactory {

    /// Factory with successful instant providers
    public static var instant: MockProviderFactory {
        MockProviderFactory(
    ...
    public static var unconfigured: MockProviderFactory {
        MockProviderFactory(
    ...
    public static var transcriptionFailure: MockProviderFactory {
        MockProviderFactory(
    ...
    public static var formattingFailure: MockProviderFactory {
        MockProviderFactory(
            transcriptionProvider: .instant,
    ...
    public static func withResult(transcription: String, formatted: String) -> MockProviderFactory {

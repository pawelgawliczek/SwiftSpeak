...
public struct CustomTemplate: Codable, Identifiable {
    public let id: UUID
...
public struct VocabularyEntry: Codable, Identifiable, Equatable {
    public let id: UUID
    public var recognizedWord: String      // What the STT might produce (e.g., "john doe")
    public var replacementWord: String     // What to replace it with (e.g., "John Doe")
    ...
    public static let samples: [VocabularyEntry] = [
...
public enum VocabularyCategory: String, Codable, CaseIterable, Identifiable {
    case name = "name"

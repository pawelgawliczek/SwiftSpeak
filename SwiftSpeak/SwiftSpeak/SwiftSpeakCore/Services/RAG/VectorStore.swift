...
final class VectorStore {
    ...
    public init(embeddingModel: RAGEmbeddingModel = .openAISmall) {
    ...
    public func storeDocument(_ document: KnowledgeDocument, powerModeId: UUID) throws {
    ...
    public func getDocuments(forPowerMode powerModeId: UUID) throws -> [UUID] {
        guard db != nil else { throw VectorStoreError.databaseNotOpen }
    ...
    public func storeChunks(_ chunks: [DocumentChunk]) throws {
        guard db != nil else { throw VectorStoreError.databaseNotOpen }
    ...
    public func deleteChunks(forDocument documentId: UUID) throws {
        guard db != nil else { throw VectorStoreError.databaseNotOpen }
        try execute("DELETE FROM chunks WHERE document_id = '\(documentId.uuidString)'")
    }
    ...
    public func getTotalChunkCount() throws -> Int {
        guard db != nil else { throw VectorStoreError.databaseNotOpen }
    ...
    public func getChunkCount(forDocument documentId: UUID) throws -> Int {
        guard db != nil else { throw VectorStoreError.databaseNotOpen }

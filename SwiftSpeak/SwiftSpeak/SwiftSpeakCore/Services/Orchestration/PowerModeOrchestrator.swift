...
final class PowerModeOrchestrator: ObservableObject {
    ...
    public var isFromKeyboard: Bool = false
    ...
    public func handleQuestionAnswer(_ answer: String) async {
    ...
    public func refine(additionalInput: String) async {
    ...
    public func updateCurrentResultText(_ newText: String) {
        guard let currentResult = session.currentResult else { return }
...
public extension PowerModeOrchestrator {
    ...
    public var activeMemorySources: [String] {
        var sources: [String] = []

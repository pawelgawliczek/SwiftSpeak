...
enum KeychainKeys {
    ...
    static let openAI = prefix + "openai"
    static let anthropic = prefix + "anthropic"
    static let google = prefix + "google"
    static let elevenLabs = prefix + "elevenlabs"
    static let deepgram = prefix + "deepgram"
    static let assemblyAI = prefix + "assemblyai"
    static let deepL = prefix + "deepl"
    static let azure = prefix + "azure"
    static let local = prefix + "local"
    ...
    static func key(for provider: AIProvider) -> String {
        ...
        case .parakeetMLX: return local  // Parakeet MLX doesn't need API key, use local key
        }
    }
}

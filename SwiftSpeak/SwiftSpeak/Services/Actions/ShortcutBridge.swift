...
//  SwiftSpeak
//
//  Phase 17: Bridge to Apple Shortcuts for Power Mode actions
//  Enables running Shortcuts and optionally receiving results via x-callback-url
//
...
final class ShortcutBridge {
    ...
    private static let callbackScheme = "swiftspeak"
    ...
    var timeout: TimeInterval = ShortcutBridge.defaultTimeout
    ...
    /// Call this from your app's URL handler when receiving a swiftspeak://shortcut-result URL

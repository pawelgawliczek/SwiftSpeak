//
//  MacTextToSpeechService.swift
//  SwiftSpeakMac
//
//  Phase 17: Text-to-Speech service for Power Mode output actions on macOS
//  Uses NSSpeechSynthesizer (or AVSpeechSynthesizer) to read results aloud
//
...
// MARK: - Mac Text to Speech Service

@MainActor
final class MacTextToSpeechService: NSObject {
...
extension MacTextToSpeechService: AVSpeechSynthesizerDelegate {
